...
class Product(models.Model):
    ...
    search_synonyms = models.TextField(
        ...
        blank=True,
        help_text='Синонимы для поиска через запятую: айфон, iphone, смартфон apple'
    )
...
class Order(models.Model):
    ...
    # Связи
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, verbose_name='Пользователь',related_name='main2_orders')
